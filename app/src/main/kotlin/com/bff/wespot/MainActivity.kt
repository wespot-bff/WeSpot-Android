...
private enum class RestrictionContent(
    ...
    TYPE1(
        string.restriction_title,
        string.restriction_type1_body1,
        string.restriction_type1_body2,
        string.restriction_type1_body3,
        string.restriction_type1_body4,
    ),

    TYPE2(
        string.restriction_title,
        string.restriction_type1_body1,
        string.restriction_type2_body2,
        string.restriction_type2_body3,
    ),

    TYPE3(
        string.restriction_title,
        string.restriction_type1_body1,
        string.restriction_type3_body2,
        string.restriction_type3_body3,
        null,
        2,
    );
}
