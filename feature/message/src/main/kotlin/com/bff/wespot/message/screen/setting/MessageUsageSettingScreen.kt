...
interface MessageUsageSettingNavigator {
    fun navigateUp()
}
...
@Destination
@Composable
fun MessageUsageSettingScreen(
    viewModel: MessageUsageViewModel = hiltViewModel(),
    navigator: MessageUsageSettingNavigator,
) {
    ...
    LifecycleStartEffect(Unit) {
        onStopOrDispose {
            action(MessageUsageSettingAction.OnLifecycleStop)
        }
    }
}
