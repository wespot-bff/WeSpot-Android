...
sealed interface ReceiverAction {
    ...
    data class OnProfileBottomSheetSelected(val senderProfile: SenderProfile) : ReceiverAction
    data object OnProfileAddButtonClicked : ReceiverAction
    data class OnSearchContentChanged(val content: String) : ReceiverAction
    data class OnUserSelected(val user: User) : ReceiverAction
    ...
    data class OnAnonymousProfileSelected(val profile: AnonymousProfile) : ReceiverAction
