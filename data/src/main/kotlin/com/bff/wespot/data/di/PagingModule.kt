...
import com.bff.wespot.data.repository.community.CommunityContentPagingRepository
...
interface PagingModule {
    ...
    @Binds
    @Singleton
    fun bindsCommunityContentRepository(
        communityContentRepositoryImpl: CommunityContentPagingRepository
